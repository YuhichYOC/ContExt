...
namespace SqlGrep {
    ...
    public class PatternPicker {
        ...
        public void Read(string path) {
            ...
            c_function.Add(PATTERN_LABEL_FUNCTIONS);
            c_function.Add(PATTERN_LABEL);
            Condition c_packageBody = new Condition();
            c_packageBody.Add(PATTERN_LABEL_PACKAGEBODIES);
            c_packageBody.Add(PATTERN_LABEL);
            Condition c_package = new Condition();
            c_package.Add(PATTERN_LABEL_PACKAGES);
            c_package.Add(PATTERN_LABEL);
            Condition c_procedure = new Condition();
            c_procedure.Add(PATTERN_LABEL_PROCEDURES);
            c_procedure.Add(PATTERN_LABEL);
            Condition c_trigger = new Condition();
            c_trigger.Add(PATTERN_LABEL_TRIGGERS);
            c_trigger.Add(PATTERN_LABEL);
            Condition c_view = new Condition();
            c_view.Add(PATTERN_LABEL_VIEWS);
            c_view.Add(PATTERN_LABEL);
